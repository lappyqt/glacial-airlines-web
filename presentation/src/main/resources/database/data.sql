...
INSERT INTO flight.flight(id, route_id, aircraft_id, flight_number, departure_time, arrival_time, status) VALUES
    ...
    -- Время в пути: 2ч 25м
    (1,  1, 1, 'GA 101', '2026-06-09 06:00:00+03', '2026-06-09 10:25:00+05', 'SCHEDULED'),
    -- Время в пути: 2ч 05м
    (2,  3, 1, 'GA 102', '2026-06-09 12:00:00+05', '2026-06-09 12:05:00+03', 'SCHEDULED'),
    -- Время в пути: 2ч 15м
    (3,  1, 1, 'GA 101', '2026-06-14 06:00:00+03', '2026-06-14 10:15:00+05', 'SCHEDULED'),
    -- Время в пути: 2ч 20м
    (4,  3, 1, 'GA 102', '2026-06-14 13:00:00+05', '2026-06-14 13:20:00+03', 'SCHEDULED'),
    -- Время в пути: 2ч 30м
    (5,  1, 1, 'GA 101', '2026-06-20 07:00:00+03', '2026-06-20 11:30:00+05', 'SCHEDULED'),
    -- Время в пути: 2ч 12м
    (6,  3, 1, 'GA 102', '2026-06-20 14:00:00+05', '2026-06-20 14:12:00+03', 'SCHEDULED'),
    -- Время в пути: 2ч 18м
    (7,  1, 1, 'GA 101', '2026-06-25 06:00:00+03', '2026-06-25 10:18:00+05', 'SCHEDULED'),
    -- Время в пути: 2ч 08м
    (8,  3, 1, 'GA 102', '2026-06-25 11:00:00+05', '2026-06-25 11:08:00+03', 'SCHEDULED'),

    -- Показательная дата: 12 июня (два самолета SVX - FRA)
    -- Airbus A320. Время в пути: 7ч 15м
    (9,  4, 1, 'GA 201', '2026-06-12 08:00:00+05', '2026-06-12 12:15:00+02', 'SCHEDULED'),
    -- Boeing 737 MAX. Время в пути: 7ч 45м
    (10, 4, 2, 'GA 203', '2026-06-12 14:00:00+05', '2026-06-12 18:45:00+02', 'SCHEDULED'),

    -- Показательная дата: 17 июня (два самолета FRA - SVX)
    -- Airbus A320. Время в пути: 7ч 20м
    (11, 6, 1, 'GA 202', '2026-06-17 09:00:00+02', '2026-06-17 19:20:00+05', 'SCHEDULED'),
    -- Boeing 737 MAX. Время в пути: 7ч 35м
    (12, 6, 2, 'GA 204', '2026-06-17 16:00:00+02', '2026-06-18 02:35:00+05', 'SCHEDULED'),

    -- Boeing 737 MAX: DME - FRA
    -- Время в пути: 4ч 15м
    (13, 2, 2, 'GA 203', '2026-06-11 09:00:00+03', '2026-06-11 12:15:00+02', 'SCHEDULED'),
    -- Время в пути: 3ч 50м
    (14, 5, 2, 'GA 204', '2026-06-11 14:00:00+02', '2026-06-11 18:50:00+03', 'SCHEDULED'),
    -- Время в пути: 4ч 05м
...
INSERT INTO
    ...
    (11, 'test@mail.com',           '+79031987655', 'Test',     'Test',      'Test',          '$2a$10$EydK3X3Qqu1VEuWqKaSIe.cb0YfHoxxvBGaTnkl3UdzNy0QG0kMHC', '2026-05-10 14:00:00+00', true,  'EMAIL', 11, 11);
...
INSERT INTO
    ...
    VALUES
    (1, 1,  1,  2,    'BUSINESS', 'PENDING_PAYMENT',    17000.00,  1644, 34,  'm.voronov@gmail.com',     '+79164328811', '2026-05-15 10:00:00+00', '2026-05-15 11:00:00+00'),
    (2, 2,  9,  11,   'ECONOMY',  'PAID',      90000.00,  320,  563, 'e.savitskaya@outlook.com','+79257113455', '2026-05-20 14:00:00+00', '2026-05-20 15:00:00+00'),
    (3, 3,  2,  1,    'ECONOMY',  'PENDING_PAYMENT',    17800.00,  0,    35,  'r.kravtsov@gmail.com',    '+79031456699', '2026-05-25 09:00:00+00', '2026-05-25 10:00:00+00'),
    (4, 4,  3,  4,    'ECONOMY',  'PAID',      17000.00,  0,    34,  'a.belova@gmail.com',      '+79652341122', '2026-06-01 11:00:00+00', '2026-06-01 12:00:00+00'),
    (5, 5,  5,  6,    'BUSINESS', 'PAID',      50000.00,  0,    250, 'd.orlov@yandex.ru',       '+79031122334', '2026-06-02 08:00:00+00', '2026-06-02 09:00:00+00'),
    (6, 6,  9,  NULL, 'ECONOMY',  'PAID',      45000.00,  0,    225, 'yu.morozova@gmail.com',   '+79167788990', '2026-06-03 16:00:00+00', '2026-06-03 17:00:00+00'),
    (7, 8,  10, 12,   'BUSINESS', 'COMPLETED', 230000.00, 0,    1150, 'n.gromova@outlook.com',   '+79251234567', '2026-05-01 12:00:00+00', '2026-05-01 13:00:00+00');
...
INSERT INTO account.loyalty_transaction(id, loyalty_account_id, order_id, transaction_type, miles, created_at) VALUES
    (1, 1, 1, 'SPENT', 1644, '2026-05-15 10:00:00+00'),
    (2, 1, 1, 'EARNED', 34,  '2026-05-15 10:00:00+00'),
    (3, 2, 2, 'SPENT', 320,  '2026-05-20 14:00:00+00'),
    (4, 2, 2, 'EARNED', 563, '2026-05-20 14:00:00+00'),
    (5, 3, 3, 'EARNED', 35,  '2026-05-25 09:00:00+00'),
    (6, 4, 4, 'EARNED', 34,  '2026-06-01 11:00:00+00'),
    (7, 5, 5, 'EARNED', 250, '2026-06-02 08:00:00+00'),
    (8, 6, 6, 'EARNED', 225, '2026-06-03 16:00:00+00'),
    (9, 8, 7, 'EARNED', 1150,'2026-05-01 12:00:00+00'),
    (10, 11, 7, 'EARNED', 150,'2026-05-01 12:00:00+00');
